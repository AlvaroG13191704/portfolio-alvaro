...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p>
            ...
            <a href="https://github.com/AlvaroG13191704" target="_blank" class="text-violet-400"
                >AlvaroG13191704<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/alvarog13181704/" target="_blank" class="text-violet-400"
                >Alvaro García<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
